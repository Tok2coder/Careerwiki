...
# 처리 대상 직업 (R44_J14 — ENHANCE 모드, marker 미보유 신규, 1직업-1세션)

| # | name | id | slug | industry_class | URL pool hint |
|---|---|---|---|---|---|
| 1 | 라이브 사운드 엔지니어 | 1765284143061792 | 라이브-사운드-엔지니어 | (자체 분류: niche/minor/major — 모호 시 default major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
...
```
R44_J14 결과:
라이브-사운드-엔지니어  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN | 마커OK
