...
# 처리 대상 5 직업 (R13_B2 — ENHANCE 모드, marker 미보유 신규)

| # | name | id | slug | industry_class | URL pool hint |
|---|---|---|---|---|---|
| 1 | 견출기조작원 | 1765285535357923 | 견출기조작원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 2 | 결산사무원 | 1765284365573274 | 결산사무원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 3 | 결정기조작원 | 1765284882920527 | 결정기조작원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 4 | 결정반장 | 1765284883236948 | 결정반장 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 5 | 결정분리기조작원 | 1765284883516980 | 결정분리기조작원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
...
```
R13_B2 결과:
1. 견출기조작원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
2. 결산사무원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
3. 결정기조작원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
4. 결정반장  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
5. 결정분리기조작원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
