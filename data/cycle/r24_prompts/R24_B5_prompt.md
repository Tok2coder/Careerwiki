...
# 처리 대상 5 직업 (R24_B5 — ENHANCE 모드, marker 미보유 신규)

| # | name | id | slug | industry_class | URL pool hint |
|---|---|---|---|---|---|
| 1 | 광자기기록장치개발원 | 1765283671534369 | 광자기기록장치개발원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 2 | 광점퍼코드조립원 | 1765285373655788 | 광점퍼코드조립원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 3 | 광통신광원설계기술자 | 1765283865482691 | 광통신광원설계기술자 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 4 | 광통신시스템개발자 | 176528367306621 | 광통신시스템개발자 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 5 | 광통신연구원 | 176528367346363 | 광통신연구원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
...
```
R24_B5 결과:
1. 광자기기록장치개발원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
2. 광점퍼코드조립원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
3. 광통신광원설계기술자  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
4. 광통신시스템개발자  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
5. 광통신연구원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
