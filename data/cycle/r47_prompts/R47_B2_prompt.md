...
# 처리 대상 직업 (R47_B2 — ENHANCE 모드, marker 미보유 신규, 5직업-1세션 배치)

| # | name | id | slug | industry_class | URL pool hint |
|---|---|---|---|---|---|
| 1 | 리와인더조작원 | 1765285507976702 | 리와인더조작원 | (자체 분류: niche/major — 모호 시 default major. minor 금지: 게이트 외 분류) | 산업 소관 부처(.go.kr)·직능 협회/학회(.or.kr)·대표 기업(.co.kr) deep page + KOSIS·언론 deep article 우선. root/검색 URL 금지. **niche도 distinct≥10 필수(d<10 검증 FAIL)** |
| 2 | 리코더조립원 | 1765284619006155 | 리코더조립원 | (자체 분류: niche/major — 모호 시 default major. minor 금지: 게이트 외 분류) | 산업 소관 부처(.go.kr)·직능 협회/학회(.or.kr)·대표 기업(.co.kr) deep page + KOSIS·언론 deep article 우선. root/검색 URL 금지. **niche도 distinct≥10 필수(d<10 검증 FAIL)** |
| 3 | 리톱기계조작원 | 1765285475211564 | 리톱기계조작원 | (자체 분류: niche/major — 모호 시 default major. minor 금지: 게이트 외 분류) | 산업 소관 부처(.go.kr)·직능 협회/학회(.or.kr)·대표 기업(.co.kr) deep page + KOSIS·언론 deep article 우선. root/검색 URL 금지. **niche도 distinct≥10 필수(d<10 검증 FAIL)** |
| 4 | 리튬이온이차전지전극제조원 | 1765285334575416 | 리튬이온이차전지전극제조원 | (자체 분류: niche/major — 모호 시 default major. minor 금지: 게이트 외 분류) | 산업 소관 부처(.go.kr)·직능 협회/학회(.or.kr)·대표 기업(.co.kr) deep page + KOSIS·언론 deep article 우선. root/검색 URL 금지. **niche도 distinct≥10 필수(d<10 검증 FAIL)** |
| 5 | 리튬이온이차전지충방전원 | 1765285334967680 | 리튬이온이차전지충방전원 | (자체 분류: niche/major — 모호 시 default major. minor 금지: 게이트 외 분류) | 산업 소관 부처(.go.kr)·직능 협회/학회(.or.kr)·대표 기업(.co.kr) deep page + KOSIS·언론 deep article 우선. root/검색 URL 금지. **niche도 distinct≥10 필수(d<10 검증 FAIL)** |
...
```
R47_B2 결과:
리와인더조작원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN | 마커OK
리코더조립원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN | 마커OK
리톱기계조작원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN | 마커OK
리튬이온이차전지전극제조원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN | 마커OK
리튬이온이차전지충방전원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN | 마커OK
