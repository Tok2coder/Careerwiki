...
- 세션당 직업 1건 (기존 5건). 배경: R42(4세션)·R43(B4) session limit 사망 사고 — 5직업 세션이 한도 근처 운행. 1직업 단위 분리로 사망 반경 축소 + 재개 오버헤드 제거 + idempotent 경계 명확화.
- 동시 spawn 상한 5 (wave 단위: J1~J5 → J6~J10 → ...). 1 cycle = 준비 1 + 작업 25(J1~J25) + 검증 1(sonnet).
