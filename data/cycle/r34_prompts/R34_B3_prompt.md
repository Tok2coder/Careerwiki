...
# 처리 대상 5 직업 (R34_B3 — ENHANCE 모드, marker 미보유 신규)

| # | name | id | slug | industry_class | URL pool hint |
|---|---|---|---|---|---|
| 1 | 기관차기관조사 | 1765285414538324 | 기관차기관조사 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 2 | 기관차배차원 | 1765284304344576 | 기관차배차원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 3 | 기관차정비반장 | 1765284659715547 | 기관차정비반장 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 4 | 기금모금가 | 1765284027863401 | 기금모금가 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 5 | 기내식공급계획사무원 | 1765284261960667 | 기내식공급계획사무원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
...
```
R34_B3 결과:
1. 기관차기관조사  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
2. 기관차배차원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
3. 기관차정비반장  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
4. 기금모금가  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
5. 기내식공급계획사무원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
