...
# 처리 대상 5 직업 (R38_B2 — ENHANCE 모드, marker 미보유 신규)

| # | name | id | slug | industry_class | URL pool hint |
|---|---|---|---|---|---|
| 1 | 내레이션강사 | 1765284046928183 | 내레이션강사 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 2 | 내레이터모델 | 1765284530900728 | 내레이터모델 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 3 | 내비게이션도로조사원 | 1765283772031299 | 내비게이션도로조사원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 4 | 내비게이션도로조사후처리원 | 1765283700455678 | 내비게이션도로조사후처리원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 5 | 내비게이션항법지도개발자 | 1765283700732351 | 내비게이션항법지도개발자 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
...
```
R38_B2 결과:
1. 내레이션강사  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
2. 내레이터모델  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
3. 내비게이션도로조사원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
4. 내비게이션도로조사후처리원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
5. 내비게이션항법지도개발자  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
