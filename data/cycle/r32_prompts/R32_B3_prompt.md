...
# 처리 대상 5 직업 (R32_B3 — ENHANCE 모드, marker 미보유 신규)

| # | name | id | slug | industry_class | URL pool hint |
|---|---|---|---|---|---|
| 1 | 금융기관감독원 | 1765284090990588 | 금융기관감독원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 2 | 금융기관지역사업부장 | 176528355795060 | 금융기관지역사업부장 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 3 | 금융기관지점관리사무원 | 1765284368255746 | 금융기관지점관리사무원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 4 | 금융기관지점관리자 | 1765283558266619 | 금융기관지점관리자 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
| 5 | 금융대출감정사무원 | 1765284368538570 | 금융대출감정사무원 | (sub-agent 자체 분류: niche/minor/major) | 한국 1차 정부·협회·기업·언론 deep — slug별 도메인 자동 발굴 |
...
```
R32_B3 결과:
1. 금융기관감독원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
2. 금융기관지역사업부장  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
3. 금융기관지점관리사무원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
4. 금융기관지점관리자  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
5. 금융대출감정사무원  | rev=NNNN | distinct=NN | totalE=NN | class | CLEAN
