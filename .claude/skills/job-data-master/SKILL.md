...
24. **WL-FULL-CYCLE — 풀 사이클 100% 적용** (2026-05-18 신규) — 배치 모드 force-enhance 시 어떤 영역도 skip 금지. **minimal patch 금지** / **"시간 부담"·"별도 사이클 위탁" 핑계 금지** / **detailReady 본문 [N] 마커 갯수 감소 금지** (이미 박힌 마커 보존 — `detectArrayMarkerCountDecrease`). 강제 처리 영역: prose body 9개 (way·summary·duties·prospect·trivia·abilities·wlb·social·overviewWork) 100자+ → [N]+sources / detailReady array 3개 모든 항목 [N]+sources 1:1 / sidebar 3개 root → deep / **distinct URL count ≥ 18** (룰 Z 강화). **정당한 skip**: careernet canonical 보존 (researchList·certificate·pathExplore·summary·duties·overviewWork) / 정치 risk careerTree / 본문 100자 미만. **Self-Report 형식**: `patch 영역 / skip 영역 + 사유 / distinct URL count after / detailReady 마커 처음→끝 / careerTree INSERT`. **위반**: minimal patch 보고 시 사고 간주, STOP. **2026-05-18 사고**: R1 B3 minimal patch로 R1 25/25 모두 URL count 미달. `feedback_full_cycle_no_minimal_patch.md` 참조
