...
| `trivia` | 출처 있는 팩트 1개 | 뻔한 직업 설명 금지. 의외의 통계/현실. **[N]은 반드시 trivia 전체의 마지막 문장 끝(마침표 뒤)에만 배치** — 첫/중간 문장 뒤에 [N]을 넣고 이후 문장을 이어서는 안 됨. 위반 시 `[Trivia/각주중간배치]` FAIL. 각 문장이 다른 출처인 경우 해당 문장 끝에 각각 [N] 배치하되, 마지막 [N] 뒤에 추가 문장 금지. |
