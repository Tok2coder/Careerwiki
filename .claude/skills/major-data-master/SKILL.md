...
- 🔴 bullet 규격(M0-r2 재발 방지 + Jason 정책 상향 2026-07-02): 항목 끝 마침표 금지(룰 X) · **1 bullet 1 고유 마커**(재사용=dup FAIL) · **전 bullet 각주 필수 — 무마커 bullet 금지**(cover 불가 편집성 문장은 sourced fact로 교체) · 재POST 시 id 연속성 유지(idxGap — delete+re-add로 복구).
