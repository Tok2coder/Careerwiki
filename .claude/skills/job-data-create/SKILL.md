...
description: 새 직업 생성 스킬. CareerWiki에 완전히 새로운 직업을 추가할 때 사용한다. "새 직업 추가", "직업 생성", "직업 만들어줘", "job create", "없는 직업 추가", "스텁 생성", "직업 추가해줘" 등이 나오면 반드시 이 스킬을 사용한다. 기존 직업의 빈 필드를 채우는 작업은 job-data-master 스킬 사용.
---
