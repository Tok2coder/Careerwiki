      ...
      <header class="mb-8 space-y-3">
        ...
        <div class="flex items-center gap-2 shrink-0 self-end md:self-center">
          <a href="/howto/guide:%EA%B0%80%EC%9D%B4%EB%93%9C-%EC%9E%91%EC%84%B1%EB%B2%95"
             class="inline-flex items-center justify-center w-[40px] sm:w-[44px] min-h-[40px] sm:min-h-[44px] border border-white/20 hover:border-wiki-primary/50 text-wiki-muted hover:text-white text-sm sm:text-base rounded-xl transition"
             title="가이드 작성법">
