            ...
            <div class="flex items-center gap-2 shrink-0">
              ${renderEntityActionGroup(
                ...
                `<div class="relative" data-share-root>
                  <button type="button" class="cw-icon-btn cw-icon-btn--share" data-share-trigger data-share-path="/major/${escapeHtml(profile.id)}" data-share-title="${escapeHtml(profile.name)}" data-share-og-image="${heroImageUrl ? escapeHtml(heroImageUrl) : '/images/og-default.png'}" aria-label="공유" title="공유">
