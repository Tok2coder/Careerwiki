...
const TERMS: Record<string, Term[]> = {
  ...
  '신고·제재': [
    ...
    { term: '즉시 영구 정지', desc: '아동성착취·폭력 협박·재직 사칭 등 명백 위반에 단계 건너뛰고 즉시 영구.' },
    { term: '차단 회피', desc: '제재 중에 부계정·다른 IP로 활동하는 행위. 적발 시 즉시 영구.' },
    { term: '신고권 박탈', desc: '허위 신고 누적 3회 시 신고 권한을 박탈하는 어뷰징 방어 조치.' }
  ],
  '커뮤니티·익명성': [
    { term: 'Tier (티어)', desc: 'Careerwiki의 4단계 사용자 권한 체계. Tier 0 비로그인 ~ Tier 3 직업 인증.' },
    { term: '인증 라벨', desc: '"현직 5년차 ○○", "○○대 4학년" 같은 작성자 표시. 후기의 출처 역할.' },
    { term: '재직 사칭', desc: '실제와 다른 직업·재직처로 인증 라벨을 받는 행위. 적발 시 즉시 영구.' },
