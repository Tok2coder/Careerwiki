...
export function renderNav(userMenuHtml: string): string {
  ...
  <div id="mobile-menu" class="fixed top-[57px] left-0 right-0 bottom-0 z-40 overflow-y-auto" style="display: none; background: rgba(6, 11, 24, 0.98); backdrop-filter: blur(24px);">
    <div class="mx-auto w-full max-w-[1400px] py-4 px-4">
      ...
      <div class="mb-4 px-4 py-3 rounded-xl" style="background: rgba(17, 24, 39, 0.6); border: 1px solid rgba(139, 92, 246, 0.1);">
      ...
      <div class="flex gap-2 mb-4">
        <a href="/analyzer" class="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-white font-medium transition-all" style="background: rgba(17, 24, 39, 0.6); border: 1px solid rgba(139, 92, 246, 0.12);">
          <i class="fas fa-brain text-emerald-400"></i>
          <span>AI 추천</span>
        </a>
        <a href="/howto" class="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-white font-medium transition-all" style="background: rgba(17, 24, 39, 0.6); border: 1px solid rgba(139, 92, 246, 0.12);">
      ...
      <div id="mobile-user-menu-section" class="mb-4 rounded-xl overflow-hidden" style="background: rgba(17, 24, 39, 0.6); border: 1px solid rgba(139, 92, 246, 0.1);">
        <!-- JavaScript로 동적 렌더링 -->
      </div>
      
      <!-- 4) 하단: 개인설정, 도움말, 로그아웃 -->
      <div id="mobile-bottom-section" class="rounded-xl overflow-hidden" style="background: rgba(17, 24, 39, 0.6); border: 1px solid rgba(139, 92, 246, 0.1);">
...
export function renderNavStyles(): string {
  ...
  <style id="nav-shared-styles">
    ...
    .border-wiki-border { border-color: rgba(139, 92, 246, 0.12); }
    .glass-card { background: linear-gradient(145deg, rgba(17, 24, 39, 0.8), rgba(15, 20, 35, 0.65)); border: 1px solid rgba(139, 92, 246, 0.06); backdrop-filter: blur(14px); }
    ...
    .header-icon-button:hover { color: #ffffff; background: rgba(139, 92, 246, 0.1); }
    .header-icon-button:focus-visible { outline: 2px solid rgba(139, 92, 246, 0.7); outline-offset: 2px; }
    ...
    .nav-search-bar { display: flex; align-items: center; gap: 8px; padding: 4px 10px 4px 14px; border-radius: 9999px; background: rgba(17, 24, 39, 0.55); border: 1px solid rgba(139, 92, 246, 0.15); transition: border 0.3s ease, box-shadow 0.3s ease; }
    ...
    .nav-search-button { width: 32px; height: 32px; border-radius: 9999px; display: inline-flex; align-items: center; justify-content: center; border: none; background: linear-gradient(135deg, rgb(var(--wp, 79 70 229)) 0%, rgb(var(--ws, 139 92 246)) 100%); color: #ffffff; font-size: 14px; box-shadow: 0 6px 14px rgba(79, 70, 229, 0.25); transition: transform 0.2s ease, box-shadow 0.2s ease; cursor: pointer; }
    .nav-search-button:hover { transform: translateY(-1px); box-shadow: 0 12px 24px rgba(79, 70, 229, 0.35); }
    .nav-search-button:focus-visible { outline: 2px solid rgba(139, 92, 246, 0.7); outline-offset: 2px; }
    ...
    .nav-link::after { content: ''; position: absolute; bottom: 4px; left: 14px; right: 14px; height: 2px; background: linear-gradient(90deg, rgb(var(--wp, 79 70 229)), rgb(var(--ws, 139 92 246))); border-radius: 1px; transform: scaleX(0); transition: transform 0.2s ease; }
    .nav-link:hover { color: #ffffff; background: rgba(139, 92, 246, 0.08); }
    .nav-link:hover::after { transform: scaleX(1); }
    .nav-link:focus-visible { outline: 2px solid rgba(139, 92, 246, 0.7); outline-offset: 2px; }
