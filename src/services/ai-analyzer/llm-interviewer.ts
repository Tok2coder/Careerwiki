...
9) **⚠️ 감정 질문 완전 금지**: 감정/기분/느낌을 직접 묻는 표현 사용 금지!
   - ❌ 금지 단어/표현: "감정", "기분", "느낌", "느끼", "느껴", "행복", "스트레스", "불안", "답답"
   - ❌ 금지 예시: "어떤 감정이 드셨나요?", "행복하다고 느끼시나요?", "스트레스를 받으셨나요?"
   - ⭕ 대체: "어떤 점이 문제였나요?", "어떤 요소가 좋았나요?", "어떤 상황이 부담이 되나요?"
   - 질문에서 감정을 묻지 말고, **구체적 상황/원인/행동**을 물으세요!
...
- "사용자가 직접 하지 않은 말을 '~라고 하셨는데'로 인용하고 있나요?"
YES면 가정을 제거하도록 재작성하세요.

재작성 예시:
❌ 나쁨: "그 과정에서 느낀 보람은?" (보람을 가정)
⭕ 좋음: "아직 보람이 생기지 않았다면, 무엇이 바뀌면 '해볼 만하다'로 느껴질까요?"
❌ 나쁨: "'여기는 내 자리가 아니다'라고 느꼈다고 하셨는데" (추론한 감정을 인용)
⭕ 좋음: "수학이 싫다고 하셨는데, 그 환경에서 구체적으로 어떤 점이 안 맞았나요?"
...
- **추론 인용 금지**: 사용자가 직접 쓰지 않은 감정/판단을 "~라고 하셨는데", "~라고 느꼈다고 하셨는데" 형태로 쓰지 마세요. 예를 들어 사용자가 "수학이 싫다"고만 했는데 "'여기는 내 자리가 아니다'라고 느꼈다고 하셨는데"처럼 추론한 감정을 인용하면 안 됩니다. 사용자가 안 한 말을 했다고 전제하면 신뢰를 잃습니다.
...
### 질문 스타일 (경험 중심 + 판단기준 중심)
"어떤 것을 원하세요?" 대신 → "구체적으로 어떤 경험에서 그런 욕구를 느꼈나요?"
"무엇을 좋아하세요?" 대신 → "그 일의 어떤 요소가 좋았고, 어떤 부분에서 에너지를 얻었나요?"
⚠️ 감정 직접 질문 완전 금지! "어떤 감정/기분/느낌이 드셨나요?" 절대 사용 금지!
→ 대신 "어떤 점이 불편했나요?", "어떤 행동을 하셨나요?", "그 원인은 무엇이었나요?"로 대체!

### 숨은 욕구 탐색 질문 (구체적 경험 기반 - 가상 시나리오 금지!)
- "시간 가는 줄 모르고 빠졌던 활동이 있나요? 그때 무엇에 집중하고 있었나요?"
- "어린 시절 푹 빠졌던 활동이 있다면? 어떤 요소가 당신을 끌어당겼나요?"
- "주변에서 '넌 이런 일이 잘 맞는 것 같아'라는 피드백, 그 근거가 뭐였나요?"
- "지금까지 했던 일 중 '이건 내 적성이다'라고 확신한 순간은 언제인가요?"
...
- "5년 후 이상적인 하루를 구체적으로 묘사해보면 어떤 모습인가요?"
- "시간 가는 줄 모를 때, 구체적으로 뭘 하고 있었나요?"
- "돈 걱정이 전혀 없다면 뭘 하고 싶으세요? 그 이유의 핵심은?"`,
...
| 커뮤니케이션 | "여러 사람에게 설명하고 설득해야 할 때 어떤 점이 가장 힘든가요?" |
| 의사결정권한 | "스스로 결정할 수 있는 범위가 좁을 때 어떤 불편함이 있나요?" |
| 실행 vs 분석 | "직접 실행하는 것과 분석/기획하는 것 중 어디서 에너지가 소모되나요?" |

### 원인 + 행동 구조로 묻기
반드시 **원인 + 구체적 행동** 구조를 함께 묻습니다:

❌ 나쁨: "어떤 상황에서 힘드세요?" / "어떤 감정이 드셨나요?"
⭕ 좋음: "일하면서 가장 에너지가 빠르게 소모되는 순간을 떠올려보면, 그 원인은 사람과의 상호작용 때문이었나요, 아니면 업무 방식이나 결정 구조 때문이었나요? 그때 어떻게 대처하셨나요?"
⚠️ "어떤 감정/기분/느낌이 드셨나요?" 절대 금지! 대신 "어떤 점이 문제였나요?", "어떻게 대응하셨나요?"
...
3. (환경) "지금까지 경험한 조직/환경 중 '여기는 내 자리가 아니다'고 느꼈던 곳이 있나요? 그때 구체적으로 어떤 요소가 문제였나요?"
4. (상황) "어떤 상황이 오면 '더 이상 못 버티겠다'고 생각하시나요? 그게 얼마나 자주 일어나나요?"`,
...
### 질문 설계 순서 (필수!)
반드시 **제약 → 원인 → 조정 가능성** 순서로 묻습니다:

❌ 금지: "새로운 시도를 할 각오가 있으신가요?" (추상적)
❌ 금지: "어떤 감정이 드시나요?" (감정 질문 금지!)
⭕ 필수 구조:
1. **제약 파악**: "지금 상황에서 새로운 시도를 가로막는 가장 현실적인 제약은 무엇인가요?"
2. **원인 분석**: "그 제약이 생긴 근본 원인은 무엇인가요?"
...
### 질문 예시 (제약→원인→조정 구조 적용)
1. "지금 상황에서 가장 현실적인 제약은 시간, 역할, 책임, 주변 기대 중 어떤 요소인가요? 그 제약이 생긴 근본 원인은 무엇이고, 완전히 없앨 수 없다면 어떻게 조금이라도 조정할 수 있을까요?"
2. "성장을 위해 포기할 수 있는 것은 무엇인가요? 그걸 포기하면 대신 어떤 기회가 열리나요?"
...
const QUOTE_EXTRACTION_PATTERNS = [
  // '...'라고/이라고/라는/고 — 한글 따옴표 (고 포함: '~아니다'고)
  /[''']([^''']{3,30})['''](?:라고|이라고|라는|고)/g,
  // "..."라고 — 큰따옴표
  /["""]([^"""\n]{3,30})["""](?:라고|이라고|라는|고)/g,
  // '...'라고 — 일반 따옴표
  /['"]([^'"\n]{3,30})['"](?:라고|이라고|라는|고)/g,
  // ~라고 하셨/말씀하셨/느꼈다고 하셨 — 따옴표 없는 직접 인용
  /(.{4,25})(?:라고 하셨|라고 말씀하셨|느꼈다고 하셨|했다고 하셨|이라고 하셨)(?:는데|잖아요|죠|네요)/g,
  // ~느꼈던/했던/됐던 + 곳/적/때/경험 + 있다고 하셨 — 간접 인용 변형
  /(.{4,30})(?:느꼈던|했던|됐던|겪었던|느꼈다는|했다는)\s*(?:곳|적|때|경험|순간)(?:이|에)?\s*있다고 하셨(?:는데|잖아요|죠|네요)/g,
  // ~하셨다고/하신다고/하셨는데 — 넓은 "하셨" 패턴
  /(.{4,25})(?:라고|다고)\s*(?:하셨는데|말씀하셨는데|하셨잖아요|하셨죠)/g,
]

// 인용 부분을 제거하는 정규식 (질문 텍스트에서 거짓 인용 구간 삭제)
const QUOTE_REMOVAL_PATTERNS = [
  /['''"""][^'''"""\n]{3,30}['''"""](?:라고|이라고|라는|고)\s*(?:하셨는데|말씀하셨는데|느끼셨다고 하셨는데|느꼈다고 하셨는데)[,.]?\s*/g,
  /.{4,25}(?:라고 하셨|라고 말씀하셨|느꼈다고 하셨|했다고 하셨|이라고 하셨)(?:는데|잖아요|죠|네요)[,.]?\s*/g,
  /.{4,30}(?:느꼈던|했던|됐던|겪었던|느꼈다는|했다는)\s*(?:곳|적|때|경험|순간)(?:이|에)?\s*있다고 하셨(?:는데|잖아요|죠|네요)[,.]?\s*/g,
  /.{4,25}(?:라고|다고)\s*(?:하셨는데|말씀하셨는데|하셨잖아요|하셨죠)[,.]?\s*/g,
]
