...
## ★ 서사 인용 원칙 (P4-4, 2026-07-07 — 필수!)
- 사용자가 서술형/라운드 답변에 쓴 **원문 표현을 각 섹션의 뼈대로 직접 인용**하라. 섹션당 최소 1개 인용.
  예: "'숫자로 의사결정을 바꾸는 순간이 가장 살아있다'고 하셨습니다. 이 문장이 당신의 판단 구조의 중심입니다."
- 인용 없는 일반론("당신은 성장을 중시하는 사람입니다")만으로 섹션을 채우지 마라.
- ❌ 영어 토큰 ID(organizing, routine, art 등)를 그대로 쓰지 마라. 반드시 자연스러운 한국어로만 표현하라.
