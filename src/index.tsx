...
const securityHeadersMiddleware = async (c: any, next: any) => {
  ...
  c.header(
    ...
    "connect-src 'self' https://127.0.0.1:3210 https://localhost:3210 http://127.0.0.1:3210 http://localhost:3210 http://127.0.0.1:3211 http://localhost:3211 https://www.google-analytics.com https://pagead2.googlesyndication.com https://cdn.jsdelivr.net https://t1.kakaocdn.net https://ep1.adtrafficquality.google https://ep2.adtrafficquality.google https://fundingchoicesmessages.google.com https://www.googletagmanager.com https://csi.gstatic.com https://googleads.g.doubleclick.net https://tpc.googlesyndication.com; " +
