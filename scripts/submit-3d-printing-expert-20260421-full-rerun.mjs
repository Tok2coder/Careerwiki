...
const DRAFT_PATH = new URL('./draft-3d-printing-expert-20260421-full-rerun.json', import.meta.url);
...
const response = await fetch(API_URL, {
  ...
  body: JSON.stringify({
    ...
    careerTree: draft.careerTree,
    _careerTreeNote: draft._careerTreeNote,
